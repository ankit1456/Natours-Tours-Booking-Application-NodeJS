...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYW5raXQxNDU2IiwiYSI6ImNrc3Jya3Z6YzBwamEycW80cTFkMHZkZGgifQ.MGyYevfwdnzn9ipbGtdvKg';
...
exports.signout = exports.login = void 0;
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Welcome Logged in successfully 🙂');
...
var stripePromise = (0, _stripeJs.loadStripe)('pk_test_51JUSXrSAVvF4YxNhdmZNUWtU62YRQ7ZJLZ7TJTMftFknJW77GBm721n0FUlWdmMTeRE8UO7LNPoKl68WAD8TiVO300nYg4gV6J'); // const stripe = Stripe(
...
if (logoutButton) {
  logoutButton.addEventListener('click', _login.signout);
}
